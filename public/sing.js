...
if (authPage) {
  ...
  buttonSwitchRegister.addEventListener("click", registerSwitch);
  ...
  registerButton.addEventListener("click", function (e) {
    e.preventDefault();
    if (registerEmail.value.length == 0 || registerPassword.value.length == 0) {
      alert("please fill the blank");
    } else {
      alert("register");
    }
  ...
  // confirm password
  const passwordsConfirm = document.querySelectorAll(".user-password-confirm");
